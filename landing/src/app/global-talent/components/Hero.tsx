        ...
        <div className="lg:px-[14rem] px-4 lg:py-[1rem] ">
          ...
          <div className="md:flex">
            <div className="md:w-6/12 w-full md:py-[7rem] py-[5rem] z-10 lg:text-start text-center">
              <h1 className="text-[#4CE9B8] lg:text-3xl text-[1.5rem] font-semibold lg:max-w-[20rem]">
                Unlock Global Talent{" "}
                <p className="text-[#FFFFFF] lg:text-3xl text-[1.5rem]">
                  Your Gateway to Exceptional Hires
                </p>
              </h1>
              <p className="text-gray-500 text-[13px] py-2">
                Employing a comprehensive approach, our specialized team is
                dedicated to providing meticulously crafted and uniquely
                tailored headhunting and recruitment services, strategically
                designed to elevate and enhance the composition of your team
                with top-tier talents, fostering long-term success and
            ...
            <div className="md:w-6/12 md:py-[7rem] py-[1rem] md:pl-8 pl-0 w-full">
              <img src="/images/Hero_global.png" alt="" className="" />
            </div>
          </div>
        </div>
      </div>
